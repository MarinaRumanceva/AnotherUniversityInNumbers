...
## Шаг пятый
Для формирования названия результирующего файла используются название параметра поиска и текущие дата и время. Его можно открыть с помощью обычного **Блокнота** или **Sublime Text**.
